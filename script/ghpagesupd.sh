...
awk -v r="5" '{gsub(/subtable/,r)}1' ~/WCA-Stats-docs-auto/WCA-Stats/bestaveragewithoutsubxsingle/sub5.md.tmp > ~/WCA-Stats-docs-auto/WCA-Stats/bestaveragewithoutsubxsingle/sub5.md.tmp2 && \
awk -v r="$date" '{gsub(/today_date/,r)}1' ~/WCA-Stats-docs-auto/WCA-Stats/bestaveragewithoutsubxsingle/sub5.md.tmp2 > ~/WCA-Stats-docs-auto/WCA-Stats/bestaveragewithoutsubxsingle/sub5.md
