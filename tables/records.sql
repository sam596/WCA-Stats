...
SELECT competitionId, date, personId, personName, personCountryId, continentId, eventId, 's' format, best 'result', regionalSingleRecord 'record'
	FROM wca_stats.results_extra
	WHERE regionalSingleRecord != ''
UNION ALL
SELECT competitionId, date, personId, personName, personCountryId, continentId, eventId, 'a' format, average 'result', regionalAverageRecord 'record'
	FROM wca_stats.results_extra
