...
SELECT * FROM
(SELECT id reId, personId, competitionId, date, weekend, eventId, roundTypeId, average result, 'a' format, formatId FROM results_extra
UNION ALL
SELECT id reId, personId, competitionId, date, weekend, eventId, roundTypeId, best result, 's' format, NULL formatId FROM results_extra) a
